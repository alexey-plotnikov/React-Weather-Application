...
export const ActualTemp = {
  ...
  MODEL_ID: "actual_temp.model_id",
  FORECAST_DATE: "actual_temp.forecast_date",
  ACTUAL_TEMP_MAX: "actual_temp.actual_temp_max",
  ACTUAL_TEMP_MIN: "actual_temp.actual_temp_min",
  FORECAST_TYPE_ID: "actual_temp.forecast_type_id",
};

export const ForecastRating = {
  TABLE_NAME: "forecast_rating",
  MODEL_ID: "forecast_rating.model_id",
  FORECAST_DATE: "forecast_rating.forecast_date",
  ...
  FORECAST_TYPE_ID: "forecast_rating.forecast_type_id",
};
